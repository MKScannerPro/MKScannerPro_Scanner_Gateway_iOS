...
/**
 线程ID
 */
@property (nonatomic, assign)mk_spp_serverOperationID operationID;
...
@implementation MKSPPMQTTOperation
@synthesize executing = _executing;
@synthesize finished = _finished;

- (void)dealloc{
    NSLog(@"MKSPPMQTTOperation销毁");
}

- (instancetype)initOperationWithID:(mk_spp_serverOperationID)operationID
...
#pragma mark - MKSPPMQTTOperationProtocol
...
- (void)didReceiveMessage:(NSDictionary *)data onTopic:(NSString *)topic {
    ...
    [self dataParserReceivedData:[MKSPPMQTTTaskAdopter parseDataWithJson:data topic:topic]];
}
...
- (void)dataParserReceivedData:(NSDictionary *)dataDic{
    ...
    mk_spp_serverOperationID operationID = [dataDic[@"operationID"] integerValue];
    if (operationID == mk_spp_defaultServerOperationID || operationID != self.operationID) {
        return;
    }
