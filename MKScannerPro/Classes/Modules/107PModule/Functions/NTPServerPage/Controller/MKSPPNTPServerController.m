...
@interface MKSPPNTPServerController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKSPPNTPServerModel *dataModel;

@end

@implementation MKSPPNTPServerController

- (void)dealloc {
    NSLog(@"MKSPPNTPServerController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKScannerPro", @"MKSPPNTPServerController", @"sp_saveIcon.png") forState:UIControlStateNormal];
