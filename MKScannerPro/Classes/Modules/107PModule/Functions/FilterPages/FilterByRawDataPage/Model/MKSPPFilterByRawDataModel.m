...
- (BOOL)readFilterByRawData {
    ...
    [MKSPPMQTTInterface spp_readFilterByRawDataStatusWithDeviceID:self.deviceID macAddress:self.macAddress topic:self.topic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
