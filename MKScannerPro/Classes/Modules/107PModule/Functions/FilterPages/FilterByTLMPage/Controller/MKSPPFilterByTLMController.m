...
@interface MKSPPFilterByTLMController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKSPPFilterByTLMModel *dataModel;

@end

@implementation MKSPPFilterByTLMController

- (void)dealloc {
    NSLog(@"MKSPPFilterByTLMController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKScannerPro", @"MKSPPFilterByTLMController", @"sp_saveIcon.png") forState:UIControlStateNormal];
