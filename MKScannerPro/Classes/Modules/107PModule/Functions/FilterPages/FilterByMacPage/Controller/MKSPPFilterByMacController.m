...
@interface MKSPPFilterByMacController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKSPPFilterByMacModel *dataModel;

@end

@implementation MKSPPFilterByMacController
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKScannerPro", @"MKSPPFilterByMacController", @"sp_saveIcon.png") forState:UIControlStateNormal];
