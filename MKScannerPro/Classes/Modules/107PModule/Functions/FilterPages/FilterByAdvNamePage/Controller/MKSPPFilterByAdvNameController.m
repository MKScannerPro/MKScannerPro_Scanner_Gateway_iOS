//
//  MKSPPFilterByAdvNameController.m
...
@interface MKSPPFilterByAdvNameController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKSPPFilterByAdvNameModel *dataModel;

@end

@implementation MKSPPFilterByAdvNameController

- (void)dealloc {
    NSLog(@"MKSPPFilterByAdvNameController销毁");
}
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    if (section == 1) {
        MKSPFilterEditSectionHeaderViewModel *headerModel = [[MKSPFilterEditSectionHeaderViewModel alloc] init];
        headerModel.index = 0;
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKScannerPro", @"MKSPPFilterByAdvNameController", @"sp_saveIcon.png") forState:UIControlStateNormal];
