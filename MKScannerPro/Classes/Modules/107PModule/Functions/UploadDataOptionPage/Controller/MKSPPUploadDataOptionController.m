//
//  MKSPPUploadDataOptionController.m
...
@interface MKSPPUploadDataOptionController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKSPPUploadDataOptionModel *dataModel;

@end

@implementation MKSPPUploadDataOptionController

- (void)dealloc {
    NSLog(@"MKSPPUploadDataOptionController销毁");
}
...
- (void)loadSectionDatas {
    ...
    cellModel4.index = 3;
    cellModel4.msg = @"RAW Data-Advertising";
    cellModel4.isOn = self.dataModel.rawData_advertising;
    [self.dataList addObject:cellModel4];
    
    MKTextSwitchCellModel *cellModel5 = [[MKTextSwitchCellModel alloc] init];
    cellModel5.index = 4;
    cellModel5.msg = @"RAW Data-Response";
    cellModel5.isOn = self.dataModel.rawData_response;
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKScannerPro", @"MKSPPUploadDataOptionController", @"sp_saveIcon.png") forState:UIControlStateNormal];
