...
@class MKSPPModifyServerModel;
@interface MKSPPUpdateMQTTServerModel : NSObject<spp_updateMQTTServerProtocol>
...
@interface MKSPPModifyServerModel : NSObject
