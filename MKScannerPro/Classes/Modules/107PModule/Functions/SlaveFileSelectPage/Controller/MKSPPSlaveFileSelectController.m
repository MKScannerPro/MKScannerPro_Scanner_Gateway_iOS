//
//  MKSPPSlaveFileSelectController.m
...
@interface MKSPPSlaveFileSelectController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MKSPPSlaveFileSelectController

- (void)dealloc {
    NSLog(@"MKSPPSlaveFileSelectController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.delegate respondsToSelector:@selector(spp_slaveFileSelected:)]) {
        [self.delegate spp_slaveFileSelected:fileModel.leftMsg];
    }
