//
//  MKSPPDuplicateDataFilterController.m
...
@interface MKSPPDuplicateDataFilterController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKSPPDuplicateDataFilterModel *dataModel;

@end

@implementation MKSPPDuplicateDataFilterController

- (void)dealloc {
    NSLog(@"MKSPPDuplicateDataFilterController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKScannerPro", @"MKSPPDuplicateDataFilterController", @"sp_saveIcon.png") forState:UIControlStateNormal];
...
- (MKSPPDuplicateDataFilterModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKSPPDuplicateDataFilterModel alloc] initWithDeviceID:self.deviceModel.deviceID
