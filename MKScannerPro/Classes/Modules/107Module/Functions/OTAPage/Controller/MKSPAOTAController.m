...
@interface MKSPAOTAController ()<UITableViewDelegate,
...
@implementation MKSPAOTAController

- (void)dealloc {
    NSLog(@"MKSPAOTAController销毁");
...
- (void)startButtonPressed {
    ...
    [MKSPAMQTTInterface spa_configOTA:self.dataModel.type
        ...
        [[NSNotificationCenter defaultCenter] addObserver:self
                                                 selector:@selector(receiveOTAResult:)
                                                     name:MKSPAReceiveDeviceOTAResultNotification
                                                   object:nil];
    }
