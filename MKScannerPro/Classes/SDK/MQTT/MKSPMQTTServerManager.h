...
/**
 ...
 @param securityPolicy      securityPolicy A custom SSL security policy or nil.
 @param certificates   certificates An NSArray of the pinned certificates to use or nil.
 */
