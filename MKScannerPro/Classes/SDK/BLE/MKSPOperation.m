...
/**
 线程ID
 */
@property (nonatomic, assign)mk_sp_taskOperationID operationID;
...
- (void)peripheral:(CBPeripheral *)peripheral didUpdateValueForCharacteristic:(CBCharacteristic *)characteristic {
    [self dataParserReceivedData:[MKSPTaskAdopter parseReadDataWithCharacteristic:characteristic]];
}

- (void)peripheral:(CBPeripheral *)peripheral didWriteValueForCharacteristic:(CBCharacteristic *)characteristic {
    [self dataParserReceivedData:[MKSPTaskAdopter parseWriteDataWithCharacteristic:characteristic]];
}
...
- (void)dataParserReceivedData:(NSDictionary *)dataDic{
    ...
    mk_sp_taskOperationID operationID = [dataDic[@"operationID"] integerValue];
    if (operationID == mk_sp_defaultTaskOperationID || operationID != self.operationID) {
        return;
    }
