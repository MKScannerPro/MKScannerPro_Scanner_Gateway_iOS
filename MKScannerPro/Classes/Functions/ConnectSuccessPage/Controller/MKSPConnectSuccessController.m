//
//  MKSPConnectSuccessController.m
...
@interface MKSPConnectSuccessController ()
...
@implementation MKSPConnectSuccessController

- (void)dealloc {
    NSLog(@"MKSPConnectSuccessController销毁");
}
...
- (void)saveButtonPressed {
    ...
    [MKSPDeviceListDatabaseManager insertDeviceList:@[self.deviceModel] sucBlock:^{
        ...
        deviceModel.onLineState = MKSPDeviceModelStateOnline;
