...
@interface MKSPAboutController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation MKSPAboutController

- (void)dealloc {
    NSLog(@"MKSPAboutController销毁");
}
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath {
    MKSPAboutCellModel *model = self.dataList[indexPath.row];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    MKSPAboutPageCell *cell = [MKSPAboutPageCell initCellWithTableView:tableView];
...
- (void)loadTableDatas {
    MKSPAboutCellModel *faxModel = [[MKSPAboutCellModel alloc] init];
    faxModel.iconName = @"sp_about_faxIcon.png";
    faxModel.typeMessage = @"Fax";
    faxModel.value = @"86-75523573370-808";
    [self.dataList addObject:faxModel];
    
    MKSPAboutCellModel *telModel = [[MKSPAboutCellModel alloc] init];
    telModel.iconName = @"sp_about_telIcon.png";
    telModel.typeMessage = @"Tel";
    telModel.value = @"86-75523573370";
    [self.dataList addObject:telModel];
    
    MKSPAboutCellModel *addModel = [[MKSPAboutCellModel alloc] init];
    addModel.iconName = @"sp_about_addIcon.png";
    ...
    MKSPAboutCellModel *linkModel = [[MKSPAboutCellModel alloc] init];
    linkModel.iconName = @"sp_about_shouceIcon.png";
...
- (UIImageView *)aboutIcon{
    if (!_aboutIcon) {
        ...
        _aboutIcon.image = LOADICON(@"MKScannerPro", @"MKSPAboutController", @"sp_aboutIcon.png");
    }
    return _aboutIcon;
}
