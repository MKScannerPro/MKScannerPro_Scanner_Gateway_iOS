...
@implementation MKSPFilterRawAdvDataModel
@end

@implementation MKSPFilterConditionModel
...
- (NSDictionary *)filterName {
    mk_sp_filterRules rules = mk_sp_filterRules_off;
    if (self.advNameIson) {
        rules = (self.advNameWhiteListIson ? mk_sp_filterRules_reverse : mk_sp_filterRules_forward);
    }
    return @{
        MKSPFilterRulesKey:@(rules),
...
- (NSDictionary *)filterMacAddress {
    mk_sp_filterRules rules = mk_sp_filterRules_off;
    if (self.macIson) {
        rules = (self.macWhiteListIson ? mk_sp_filterRules_reverse : mk_sp_filterRules_forward);
    }
    return @{
        MKSPFilterRulesKey:@(rules),
...
- (NSDictionary *)filterUUID {
    mk_sp_filterRules rules = mk_sp_filterRules_off;
    if (self.uuidIson) {
        rules = (self.uuidWhiteListIson ? mk_sp_filterRules_reverse : mk_sp_filterRules_forward);
    }
    return @{
        MKSPFilterRulesKey:@(rules),
...
- (NSDictionary *)filterMajor {
    mk_sp_filterRules rules = mk_sp_filterRules_off;
    if (self.majorIson) {
        rules = (self.majorWhiteListIson ? mk_sp_filterRules_reverse : mk_sp_filterRules_forward);
    }
    return @{
        MKSPFilterRulesKey:@(rules),
...
- (NSDictionary *)filterMinor {
    mk_sp_filterRules rules = mk_sp_filterRules_off;
    if (self.minorIson) {
        rules = (self.minorWhiteListIson ? mk_sp_filterRules_reverse : mk_sp_filterRules_forward);
    }
    return @{
        MKSPFilterRulesKey:@(rules),
...
- (NSDictionary *)filterRawDatas:(NSArray <MKSPFilterRawAdvDataModel *>*)rawList {
    mk_sp_filterRules rules = mk_sp_filterRules_off;
    if (self.rawDataIson) {
        rules = (self.rawDataWhiteListIson ? mk_sp_filterRules_reverse : mk_sp_filterRules_forward);
    }
    return @{
        MKSPFilterRulesKey:@(rules),
        @"dataList":rawList,
...
- (NSDictionary *)filterConditions:(NSArray <MKSPFilterRawAdvDataModel *>*)rawList {
    ...
    NSDictionary *dataDic = @{
        MKSPFilterConditionsStatusKey:@(self.enableFilterConditions),
        MKSPFilterByRssiKey:@(self.rssiValue),
        MKSPFilterByAdvNameKey:[self filterName],
        MKSPFilterByDeviceMacKey:[self filterMacAddress],
        MKSPFilterByiBeaconUUIDKey:[self filterUUID],
        MKSPFilterByiBeaconMajorKey:[self filterMajor],
        MKSPFilterByiBeaconMinorKey:[self filterMinor],
        MKSPFilterByRawDataKey:[self filterRawDatas:rawList]
    };
    return @{
        @"code":@(1),
        @"data":dataDic
