//
//  MKSPUploadDataOptionController.m
...
@interface MKSPUploadDataOptionController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKSPUploadDataOptionModel *dataModel;

@end

@implementation MKSPUploadDataOptionController
...
- (void)rightButtonMethod {
    ...
    [MKSPServerInterface sp_configUploadDataOption:self.dataModel
...
- (void)readDataFromServer {
    ...
    [MKSPServerInterface sp_readUploadDataOptionWithDeviceID:self.deviceModel.deviceID
                                                  macAddress:self.deviceModel.macAddress
                                                       topic:[self.deviceModel currentSubscribedTopic]
                                                    sucBlock:^(id  _Nonnull returnData) {
        [[MKHudManager share] hide];
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKScannerPro", @"MKSPUploadDataOptionController", @"sp_saveIcon.png") forState:UIControlStateNormal];
...
- (MKSPUploadDataOptionModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKSPUploadDataOptionModel alloc] init];
    }
    return _dataModel;
}
