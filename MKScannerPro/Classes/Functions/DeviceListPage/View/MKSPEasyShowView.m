...
@implementation MKSPEasyShowView
...
- (UIImageView *)refreshIcon {
    if (!_refreshIcon) {
        ...
        _refreshIcon.image = LOADICON(@"MKScannerPro", @"MKSPEasyShowView", @"sp_refreshIcon.png");
    }
    return _refreshIcon;
}
