...
@interface MKSPMQTTSSLForDeviceViewModel : NSObject
...
@protocol MKSPMQTTSSLForDeviceViewDelegate <NSObject>
...
@interface MKSPMQTTSSLForDeviceView : UIView

@property (nonatomic, strong)MKSPMQTTSSLForDeviceViewModel *dataModel;

@property (nonatomic, weak)id <MKSPMQTTSSLForDeviceViewDelegate>delegate;
