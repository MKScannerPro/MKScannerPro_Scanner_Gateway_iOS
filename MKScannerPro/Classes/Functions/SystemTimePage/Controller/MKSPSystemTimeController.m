...
@interface MKSPSystemTimeController ()<UITableViewDelegate,
...
@implementation MKSPSystemTimeController

- (void)dealloc {
    NSLog(@"MKSPSystemTimeController销毁");
    if (self.readTimer) {
...
- (void)readDataFromServer {
    ...
    [MKSPServerInterface sp_readDeviceUTCWithDeviceID:self.deviceModel.deviceID
...
- (void)syncTimeZoneToDevice:(NSInteger)timeZone {
    ...
    [MKSPServerInterface sp_configDeviceTimeZone:timeZone - 12
