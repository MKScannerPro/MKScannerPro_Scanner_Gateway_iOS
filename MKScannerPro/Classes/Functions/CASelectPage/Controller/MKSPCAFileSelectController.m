...
@interface MKSPCAFileSelectController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MKSPCAFileSelectController

- (void)dealloc {
    NSLog(@"MKSPCAFileSelectController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.delegate respondsToSelector:@selector(sp_certSelectedMethod:certName:)]) {
        [self.delegate sp_certSelectedMethod:self.pageType certName:fileModel.leftMsg];
    }
