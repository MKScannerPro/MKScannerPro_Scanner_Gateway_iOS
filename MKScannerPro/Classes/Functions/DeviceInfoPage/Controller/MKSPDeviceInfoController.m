...
@interface MKSPDeviceInfoController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation MKSPDeviceInfoController

- (void)dealloc {
    NSLog(@"MKSPDeviceInfoController销毁");
}
...
- (void)readDataFromServer {
    ...
    [MKSPServerInterface sp_readDeviceInfoWithDeviceID:self.deviceModel.deviceID macAddress:self.deviceModel.macAddress topic:[self.deviceModel currentSubscribedTopic] sucBlock:^(id  _Nonnull returnData) {
